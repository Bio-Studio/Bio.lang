...
const char *DEMO2 =
    ...
    "        CIO::println(\"div 的拒绝原因:\", bad.ref);\n"
    "        ALL missing = MyCalc::sqrt(9);\n"
    "        CIO::println(\"缺失方法的拒绝:\", missing.ref);\n"
    "    }\n"
    "}\n";
...
static const char *DEMO9 =
    ...
    "        CIO::println(\"只读写 →\", Ref::write(rr, 99).ref);\n"
    "        ALL x = 42;\n"
    "        ALL rf = &r f x;\n"
...
static const char *DEMO13 =
    ...
    "        IO::println(\"无初值声明读 →\", Ref::read(dry).ref);\n"
    "        // 可移动权限 m + Ref::move\n"
    "        ALL x = 42;\n"
    ...
    "        IO::println(\"forwardBad(1,0) 拒绝原因 =\", bad.ref);\n"
    "    }\n"
    "}\n";
